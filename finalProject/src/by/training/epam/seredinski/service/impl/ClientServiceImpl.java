...
public class ClientServiceImpl implements ClientService {
    ...
    @Override
    public User registration(String email, String password, String login, String name, String surname) throws ServiceException {
        User user = new User(email, password, login, name, surname);
